        ...
        <div className=' bg-white dark:bg-[#2b2c37] shadow-md shadow-[#364e7e1a] w-full py-4 rounded-xl'>
            ...
            <div>
                {boards.map((board, index) => (
                    <div className={` cursor-pointer flex items-baseline dark:text-white space-x-2 px-5 py-4 ${board.isActive && 'bg-[#635fc7] rounded-r-full text-white mr-9'}`} key={index}
                    onClick={() => {
