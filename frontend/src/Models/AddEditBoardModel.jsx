...
function AddEditBoardModel({ setBoardModelOpen, type , }) {
    ...
    <div className='  fixed right-0 top-0 px-2 py-4 overflow-scroll scrollbar-hide  z-50 left-0 bottom-0 justify-center items-center flex dropdown '
      ...
      <div className=' scrollbar-hide overflow-y-scroll max-h-[95vh]  bg-white dark:bg-[#2b2c37] text-black dark:text-white font-bold shadow-md shadow-[#364e7e1a] max-w-md mx-auto my-auto w-full px-8  py-8 rounded-xl'>
        ...
        <div className='mt-8 flex flex-col space-y-3'>
          ...
          <div>
            <button className=' button w-full items-center hover:opacity-70 dark:text-[#635fc7] dark:bg-white  text-white bg-[#635fc7] py-2 rounded-full '
              onClick={() => {
                setNewColumns((state) => [
                  ...state,
            ...
            <button onClick={() => {
              ...
              }} className=' button w-full items-center hover:opacity-70 dark:text-white dark:bg-[#635fc7] mt-8 relative  text-white bg-[#635fc7] py-2 rounded-full'>
